...
public class Compras {
	...
	public Compras(Cliente cliente, Voos voo, int diaCompra, int mesCompra, int anoCompra, int hCompra, int minCompra,
			int segCompra) { // Item 1M) criação de compras
		setCliente(cliente);
		adicionarVoo(voo);
	...
	public Compras(Cliente cliente, Quarto quarto, int diaCompra, int mesCompra, int anoCompra, int hCompra,
			int minCompra, int segCompra) {
		setCliente(cliente);
