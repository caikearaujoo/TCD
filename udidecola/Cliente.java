...
public class Cliente extends Pessoa {
	...
	private ArrayList<Pesquisas> pesquisas; // Item 8a) extra: cada cliente terá um ArrayList de pesquisas associada a
											// ele.
	// Basicamente todo cliente terá um ArrayList que armazenará as suas pesquisas e
	// compras de forma específica, tornando cada um deles
	// mais individual ainda, além de facilitar o acesso de histórico tanto de
	// pesquisas quanto de compras.
	...
	// item 1K: método que transforma um cliente em vip a partir do seu número de
	// compras
