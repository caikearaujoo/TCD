...
public class Voos {
	...
	// item 1e) possibilidade de diferentes horários e trecho e voo são
	// estabelecidos aqui
	public Voos(int diaVoo, int mesVoo, int anoVoo, int hSaida, int minSaida, int segSaida, int hChegada,
			int minChegada, int segChegada, int vagas, double preco) {
	...
	public void setPreco(int diaVoo, int mesVoo, int anoVoo, double preco) { // Item 1e) variação de preço de passagens
																				// de acordo com eventos ou datas do ano
