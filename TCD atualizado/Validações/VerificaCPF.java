...
package validacoes; // pacote criado para guardar as verificações de cpf e de cnpj
...
public class VerificaCPF {
	public static boolean isCPF(String CPF) {
		...
		// try - protege o código para eventuais erros de tipo (int)
		try {
			// cálculo do 1º dígito verificador
			sm = 0;
			peso = 10;
			for (i = 0; i < 9; i++) {
				// converte o i-ésimo caracter do CPF em um número
